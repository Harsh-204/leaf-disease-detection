...
def test_with_base64_data(base64_image_string: str, mime_type: str = 'image/jpeg'):
    """
    ...
    try:
        ...
        result = detector.analyze_leaf_image_base64(base64_image_string, mime_type=mime_type)
...
def convert_image_to_base64_and_test(image_bytes: bytes, mime_type: str = 'image/jpeg'):
    """
    ...
    try:
        ...
        return test_with_base64_data(base64_string, mime_type=mime_type)
    except Exception as e:
        print(f'{{"error": "{str(e)}"}}')
        return None
